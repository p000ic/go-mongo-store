...
func TestMongoStore(t *testing.T) {
	...
	connStr := "mongodb://" + o.Host + ":" + strconv.Itoa(o.Port)
	...
	if o.Auth {
		...
		connStr = "mongodb://" + o.Username + ":" + o.Password + "@" + o.Host + ":" + strconv.Itoa(o.Port)
	}
	dbSess, err := qmgo.NewClient(context.Background(), &dbConfig)
	if err != nil {
		panic(err)
	}
	defer dbSess.Close(context.Background())
